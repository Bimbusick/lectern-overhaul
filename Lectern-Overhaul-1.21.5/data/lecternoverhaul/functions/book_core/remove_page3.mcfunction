$summon item_display ~ ~ ~ {Tags:["lectern.book.page","set.score"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,-0.195f,-0.981f,0f],translation:[0.15625f,0.08f,-0.137f],scale:[1f,1f,1f]},item:{id:"minecraft:firework_star",count:1,components:{"minecraft:custom_model_data":148802}},interpolation_duration:3,Rotation:[$(rotation)f,0f]}
